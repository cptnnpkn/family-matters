...
aliases: ["Chapter 8: Audience in Gauntlgrym"]
---
...
The Vault of Kings is heavily patrolled and guarded by shield dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) traveling in squads of six. It is the safest part of the city, and the characters can probably depend upon its security enough to rest without interruption in one of the guest suites provided to them, barring any unusual occurrences (see "Events in Gauntlgrym").
...
Unlike the rest of the Iron Tabernacle, the tombs are unmarred. Spectral dwarves are common in this area, though their spirits remain quiet as long as visitors are respectful of the dead. If any creatures attempt to deface or steal from the sarcophagi, a mob of dwarven [ghosts](/3-Mechanics/CLI/bestiary/undead/ghost.md) quickly attacks. Start with a total number of ghosts equal to the number of intruders present, then add two new ghosts for each ghost destroyed.
...
|-----------|-----------|
| 1–12 | No encounter |
| 13 | 1 [cloaker](/3-Mechanics/CLI/bestiary/aberration/cloaker.md) |
| 14 | `1d2` [driders](/3-Mechanics/CLI/bestiary/monstrosity/drider.md) |
| 15 | 1 dwarf [ghost](/3-Mechanics/CLI/bestiary/undead/ghost.md) (friendly unless attacked) |
| 16 | Patrol consisting of six shield dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) |
| 17 | 1 shield dwarf [priest](/3-Mechanics/CLI/bestiary/humanoid/priest.md) and `1d4 + 1` shield dwarf [acolytes](/3-Mechanics/CLI/bestiary/humanoid/acolyte.md) |
| 18 | `1d6 + 1` [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle.md) |
| 19 | 1 [grick alpha](/3-Mechanics/CLI/bestiary/monstrosity/grick-alpha.md) and `1d4 + 1` [gricks](/3-Mechanics/CLI/bestiary/monstrosity/grick.md) |
| 20 | `1d4` [rust monsters](/3-Mechanics/CLI/bestiary/monstrosity/rust-monster.md) |
^encounter
...
The king has left the day-to-day running of the Great Forge to a pair of experienced smiths: Helgrim Candlewick and Rollo Summergold (both shield dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md)).

#### Great Forge Random Encounters

The Great Forge is always occupied by either Helgrim or Rollo, their apprentices and assistants (`2d4` shield dwarf [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md)), and shield dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) working in squads of six to guard the active furnaces. The characters might also encounter other creatures if they explore the unoccupied areas of the Great Forge. Check for such an encounter once per hour of travel or rest outside the protected areas of the forge by rolling a `d20` and consulting the Great Forge Encounters table to determine what, if anything, comes out of the darkness. If the heroes call for help, four shield dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) arrive in `1d4 + 1` rounds to aid them.
...
|-----------|-----------|
| 1–14 | No encounter |
| 15 | `1d4 + 1` [doppelgangers](/3-Mechanics/CLI/bestiary/monstrosity/doppelganger.md) disguised as shield dwarves |
| 16 | `1d2` [fire elementals](/3-Mechanics/CLI/bestiary/elemental/fire-elemental.md) and `3d6` [magmins](/3-Mechanics/CLI/bestiary/elemental/magmin.md) |
| 17 | 1 [salamander](/3-Mechanics/CLI/bestiary/elemental/salamander.md) and `1d4 + 1` [fire snakes](/3-Mechanics/CLI/bestiary/elemental/fire-snake.md) |
| 18 | 1 [spirit naga](/3-Mechanics/CLI/bestiary/monstrosity/spirit-naga.md) |
| 19 | `3d6` [troglodytes](/3-Mechanics/CLI/bestiary/humanoid/troglodyte.md) |
| 20 | 1 [wraith](/3-Mechanics/CLI/bestiary/undead/wraith.md) leading `1d6 + 1` [specter](/3-Mechanics/CLI/bestiary/undead/specter.md) |
^encounter
...
If you want to add some intrigue or action, consider having one of the options from "Enemies Among Us" interrupt the feast, giving the characters an opportunity to demonstrate their abilities in front of their potential patron and allies. Rogue [fire elementals](/3-Mechanics/CLI/bestiary/elemental/fire-elemental.md) roaring out of the hearth or a disguised [assassin](/3-Mechanics/CLI/bestiary/humanoid/assassin.md) poisoning one or more of the representatives can completely change the scene.
...
If the characters attack Zelraun, use the [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage.md) statistics in the *Monster Manual* to represent him.
...
If he's of a mind to provide aid, Sir Lanniver pledges five human veterans of the order to the party's mission. The veterans' names are Thora Nabal, Sylrien Havennor, Olaf Renghyi, Elias Drako, and Tamryn Tharke. Sir Lanniver can also offer a member of the party a [+1 warhammer](/3-Mechanics/CLI/items/1-weapon.md), one of a handful of treasures held in trust by the order. He prefers to bestow this weapon on a good- or neutral-aligned cleric or paladin. Feel free to swap this magic weapon with another magic item more useful to the adventurers.
...
Should Morista come under attack, use the [scout](/3-Mechanics/CLI/bestiary/humanoid/scout.md) statistics in the *Monster Manual* to represent her.
...
Should Lord Eravien come under attack, use the [noble](/3-Mechanics/CLI/bestiary/humanoid/noble.md) statistics in the *Monster Manual* to represent him. He travels with three servants (strongheart halfling [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md)) and three well-paid human [guards](/3-Mechanics/CLI/bestiary/humanoid/guard.md).
...
Davra is an [assassin](/3-Mechanics/CLI/bestiary/humanoid/assassin.md). In addition to her weapons, she carries [dust of disappearance](/3-Mechanics/CLI/items/dust-of-disappearance.md) and wears [goggles of night](/3-Mechanics/CLI/items/goggles-of-night.md) while roaming the dark halls of Gauntlgrym.
