...
The characters might disguise themselves as orcs using captured gear. Doing so can let them try to bluff their way past sentries in the dungeon, using Charisma ([Deception](/3-Mechanics/CLI/rules/skills.md#Deception)) checks contested by the orcs' Wisdom ([Insight](/3-Mechanics/CLI/rules/skills.md#Insight)) checks.
...
![](/3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-forge-of-fury/img/005-totyp-02-06.webp#center)
...
Snurrevin has a familiar, a [rat](/3-Mechanics/CLI/bestiary/beast/rat.md) named Browngnaw, that hides in the shadows near the unlit forge to the east. The duergar are preoccupied with their task and don't notice the party's entrance unless the characters make themselves known. They object violently to intruders who aren't escorted by duergar.
...
If the characters approach this area from the secret door to the south before entering area 43, Arundil the [ghost](/3-Mechanics/CLI/bestiary/undead/ghost.md) confronts them here; refer to the encounter in area 43. Otherwise, there is nothing dangerous or valuable in the area.
...
The dwarf scholar amassed a small amount of treasure, which he kept in the secret compartment: 110 gp and a cat's-eye gem worth 70 gp. In the library, in addition to an extensive collection of dwarven lore, the characters can find four [spell scrolls](/3-Mechanics/CLI/items/spell-scroll.md) (of [alarm](/3-Mechanics/CLI/spells/alarm.md), [disguise self](/3-Mechanics/CLI/spells/disguise-self.md), [enlarge/reduce](/3-Mechanics/CLI/spells/enlarge-reduce.md), and [shield](/3-Mechanics/CLI/spells/shield.md)). The shelves might also include more scrolls, useful information tying in to future adventures, items of value to a collector, or other interesting lore, as you see fit.
...
> [!gallery]
> ![Map 2.6: The Black Lake](/3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-forge-of-fury/img/013-totyp-02-13.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-forge-of-fury/img/019-tfof05.webp#gallery)
...
When Nightscale becomes aware of intruders, the [young black dragon](/3-Mechanics/CLI/bestiary/dragon/young-black-dragon.md) slips into the water, quietly swimming to a point near the three stepping stones shown on the map. Any character watching the lake can make a Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) check contested by the dragon's Dexterity ([Stealth](/3-Mechanics/CLI/rules/skills.md#Stealth)) check. On a successful check, the character catches a glimpse of a serpentine form moving in the darkness.
...
![](/3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-forge-of-fury/img/014-totyp-02-14.webp#center)
...
Nightscale keeps her treasure on the small island in the lake, and she spends most of her time resting here. If the characters have avoided attracting her attention so far and want to approach the island, they can do so quietly if every character's Dexterity ([Stealth](/3-Mechanics/CLI/rules/skills.md#Stealth)) check meets or exceeds the dragon's passive Perception score.

#### Treasure

Nightscale has accumulated considerable wealth from her plunder of Khundrukar. Her hoard contains 6,200 sp, 1,430 gp, two garnets worth 20 gp each, a black pearl worth 50 gp, a [wand of magic missiles](/3-Mechanics/CLI/items/wand-of-magic-missiles.md), a [+2 greataxe](/3-Mechanics/CLI/items/2-weapon.md) bearing Durgeddin's smith-mark, a [+1 shield](/3-Mechanics/CLI/items/1-shield.md), a [potion of healing](/3-Mechanics/CLI/items/potion-of-healing.md), and a [potion of flying](/3-Mechanics/CLI/items/potion-of-flying.md).
...
If the characters were sent to retrieve weapons for Baron Althon, they can bring him the [+1 longsword](/3-Mechanics/CLI/items/1-weapon.md) from area 22, the [+2 greataxe](/3-Mechanics/CLI/items/2-weapon.md) in area 53, the [handaxe](/3-Mechanics/CLI/items/handaxe.md) from area 14, and the [warhammer](/3-Mechanics/CLI/items/warhammer.md) from area 23. All bear Durgeddin's smith-mark; Baron Althon pays 500 gp above the market price for each mundane weapon, 1,000 gp for the [+1 longsword](/3-Mechanics/CLI/items/1-weapon.md), and 6,000 gp for the [+2 greataxe](/3-Mechanics/CLI/items/2-weapon.md), if the characters are willing to sell.
