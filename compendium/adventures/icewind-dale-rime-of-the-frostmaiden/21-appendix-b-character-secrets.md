...
> [!gallery]
> ![Page 1](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/193-character-secrets-page-1.webp#gallery)
> ![Page 2](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/194-character-secrets-page-2.webp#gallery)

## Alagondar Scion

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/195-appb-secret-alagondar-scion.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/196-appb-secret-doppelganger.webp#center)

I'm a shapechanger. I have none of the traits of the race I'm imitating, but I retain my class features, background, and alignment. I have [darkvision](/3-Mechanics/CLI/rules/senses.md#darkvision) out to a range of 60 feet. I can use an action to do either of the following at will:

- I can innately cast [detect thoughts](/3-Mechanics/CLI/spells/detect-thoughts.md), requiring no components. My spellcasting ability is Intelligence. The spell's Wisdom save DC is 8 + my proficiency bonus + my Intelligence modifier.  
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/197-appb-secret-drizzt-fan.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/198-appb-secret-elusive-paramour.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/199-appb-secret-escaped-prisoner.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/200-appb-secret-littlest-yeti.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/201-appb-secret-midwinter-child.webp#center)

Auril the Frostmaiden has blessed me, for I was born on the Midwinter holiday. I have resistance to cold damage.

## Old Flame

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/202-appb-secret-old-flame.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/203-appb-secret-orc-stone.webp#center)

I saved the life of an orc, who gave me a [stone](/3-Mechanics/CLI/items/orc-stone-idrotf.md) with the symbol of the Many-Arrows tribe (a humanoid skull pierced by three arrows) carved into it. The stone is an uncommon magic item that requires attunement, and only I can attune to it.

As an action, I can use the stone to summon the spirit of an orc warrior, which appears within 30 feet of me. The spirit uses the [orc war chief](/3-Mechanics/CLI/bestiary/humanoid/orc-war-chief.md) stat block in the "Monster Manual" and disappears after 10 minutes or when reduced to 0 hit points. The spirit understands any language I speak and obeys my commands.

After the stone is used three times, it turns to dust.

## Owlbear Whisperer

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/204-appb-secret-owlbear-whisperer.webp#center)

Owlbears are predisposed to like me.

If I am within 10 feet of an [owlbear](/3-Mechanics/CLI/bestiary/monstrosity/owlbear.md), I can use an action to make a DC 10 Charisma ([Animal Handling](/3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. On a success, I change the owlbear's attitude toward me from hostile to indifferent or from indifferent to friendly.

## Pirate Cannibal

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/205-appb-secret-pirate-cannibal.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/206-appb-secret-reghed-heir.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/207-appb-secret-reincarnation.webp#center)

I died and was brought back to life by a friendly human druid using the [reincarnate](/3-Mechanics/CLI/spells/reincarnate.md) spell. I have no idea what became of the druid, whose name I don't know. I retain the memories of my previous life, some or all of which was spent in Icewind Dale. (Roll on the table in the spell's description to determine your character's previous race, or choose a race from the table that you like, then flesh out the story of your previous life.)

## Ring Hunter

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/208-appb-secret-ring-hunter.webp#center)

I am looking for the [knucklehead trout](/3-Mechanics/CLI/bestiary/beast/knucklehead-trout-idrotf.md) that bit off my father's finger, which had a signet ring on it. To preserve my inheritance, I must retrieve the lost ring.

## Runaway Author

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/209-appb-secret-runaway.webp#center)
...
![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/210-appb-secret-slaad.webp#center)

A [red slaad](/3-Mechanics/CLI/bestiary/aberration/red-slaad.md) implanted a pellet-sized egg in me shortly before I started my adventuring career. If I can't get rid of it in the next two months, the egg will gestate inside me, and a slaad tadpole will burst from my chest, killing me. It will then quickly grow into an adult slaad and kill even more people.

## Spy

![](/3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/211-appb-secret-spy.webp#center)
