...
| 17 | A piece of [parchment](/3-Mechanics/CLI/items/parchment-one-sheet.md), listing fourteen magical pools and their effects when touched |
| 18 | A vial filled with a dark, fizzy liquid that is sealed and cannot be opened |
| 19 | A feeler taken from a slain [rust monster](/3-Mechanics/CLI/bestiary/monstrosity/rust-monster.md) |
...
`dice: [](1-introduction.md#^a-mysterious-stranger-offers-a-quest)`
...
`dice: [](1-introduction.md#^the-mysterious-strangers-secret)`
...
| 6 | Is the [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed) thrall of a [mind flayer](/3-Mechanics/CLI/bestiary/aberration/mind-flayer.md) |
| 7 | Is possessed by a [ghost](/3-Mechanics/CLI/bestiary/undead/ghost.md) |
| 8 | Is a [solar](/3-Mechanics/CLI/bestiary/celestial/solar.md) in disguise |
^the-mysterious-strangers-secret
...
![](/3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-against-the-giants/img/durnan.webp#center)
...
`dice: [](1-introduction.md#^denizens-of-the-yawning-portal)`
