...
| 4 | Escort a [Returned sentry](/3-Mechanics/CLI/bestiary/undead/returned-sentry-mot.md) (see "chapter 6") escaping from the Underworld into the mortal world. |
| 5 | Bargain with a [lampad](/3-Mechanics/CLI/bestiary/fey/lampad-mot.md) (see "chapter 6") to learn where the body of a lost hero lies entombed. |
...
| 12 | Capture an [Underworld cerberus](/3-Mechanics/CLI/bestiary/monstrosity/underworld-cerberus-mot.md) (see "chapter 6"). |
^underworld-crossing-adventures