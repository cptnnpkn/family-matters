...
- **Skill Proficiencies.** Two of the following: [Arcana](/3-Mechanics/CLI/rules/skills.md#Arcana), [Deception](/3-Mechanics/CLI/rules/skills.md#Deception), [Investigation](/3-Mechanics/CLI/rules/skills.md#Investigation), [Perception](/3-Mechanics/CLI/rules/skills.md#Perception)  
- **Tool Proficiencies.** Either calligraphers' supplies or alchemists' supplies  
- **Languages.** Draconic or Elvish  
- **Equipment.** A gnarled [wand](/3-Mechanics/CLI/items/wand.md) made of wood, a duster jacket, a satchel for material components and potions, an [amulet](/3-Mechanics/CLI/items/amulet.md) or other [trinket](/3-Mechanics/CLI/items/trinket.md) of importance to you  
