...
![](/3-Mechanics/CLI/rules/variant-rules/img/gos-095-za-05-travel-at-sea-p199.webp#center)
...
The character casts fishing lines, keeping an eye out for sources of food, making a Wisdom ([Survival](/3-Mechanics/CLI/rules/skills.md#Survival)) check when the DM calls for it.

### Raise Morale (First Mate Only)

The first mate can manage the crew's time to grant extended breaks, provide instruction, and generally improve the quality of life on the ship. Once every 24 hours, if the crew's quality score is 3 or lower, the first mate can make a DC 15 Charisma ([Persuasion](/3-Mechanics/CLI/rules/skills.md#Persuasion)) check. On a successful check, the crew's quality score increases by 1.

### Navigate (Quartermaster Only)

The quartermaster can try to prevent the ship from becoming lost, making a Wisdom ([Survival](/3-Mechanics/CLI/rules/skills.md#Survival)) check when the DM calls for it. (See ""Becoming Lost"" in chapter 5 of the "Dungeon Master's Guide" for more information.)

### Noticing Threats

Use the passive Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) score of the player characters or the crew to determine whether anyone on the ship notices a hidden threat. The crew has a passive Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) score equal to 10 + the crew's quality score. The DM might decide that a threat can be noticed only by characters in a specific area of the ship. For example, only characters below deck might have a chance to hear or spot a creature hiding on board.

### Repair (Bosun Only)

At the end of the day, the ship's bosun can make a Strength check using [carpenter's tools](/3-Mechanics/CLI/items/carpenters-tools.md). On a 15 or higher, each damaged component regains hit points equal to `1d6` + the crew's quality score (minimum of 1 hit point). A component other than the hull that had 0 hit points becomes functional again.
...
| Officer | Check |
|---------|-------|
| Captain | Charisma ([Intimidation](/3-Mechanics/CLI/rules/skills.md#Intimidation)) |
| First mate | Charisma ([Intimidation](/3-Mechanics/CLI/rules/skills.md#Intimidation)) |
| Cook | Intelligence ([brewer's supplies](/3-Mechanics/CLI/items/brewers-supplies.md)) |
^crew-conflict-checks
...
| Surgeon | Intelligence ([Medicine](/3-Mechanics/CLI/rules/skills.md#Medicine)) |
^fire-checks
...
|---------|-------|
| Captain | Intelligence (water vehicles) |
| First mate | Charisma ([Persuasion](/3-Mechanics/CLI/rules/skills.md#Persuasion)) |
| Surgeon | Intelligence ([Medicine](/3-Mechanics/CLI/rules/skills.md#Medicine)) |
| Cook | Constitution ([cook's utensils](/3-Mechanics/CLI/items/cooks-utensils.md)) |
^infestation-checks
