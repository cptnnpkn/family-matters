...
---
# [Spellcaster (Mage)](3-Mechanics\CLI\bestiary\humanoid/spellcaster-mage-dc.md)
...
- "desc": "The spellcaster's spellcasting ability is Intelligence (spell save DC 16,\
    \ +8 to hit with spell attacks). The spellcaster has following wizard spells\
    ...
    \ [cone of cold](/3-Mechanics/CLI/spells/cone-of-cold.md), [hold monster](/3-Mechanics/CLI/spells/hold-monster.md)\n\
...
"source":
- "DC"
"image": "/3-Mechanics/CLI/bestiary/humanoid/token/spellcaster-mage-dc.webp"
```
^statblock