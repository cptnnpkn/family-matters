...
- "desc": "When an attacker the assassin can see hits the assassin with an attack,\
  ...
  "name": "Uncanny Dodge"
"legendary_actions":
- "desc": "The assassin escapes nonmagical restraints and ends the [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "desc": "The assassin creates a sudden distraction, such as a cloud of disorienting\
    ...
    \ psychic damage, and the assassin has the [invisible](/3-Mechanics/CLI/rules/conditions.md#invisible)\
