...
- "desc": "The speaker casts one of the following spells, using Charisma as the spellcasting\
    ...
    \n1/day each: [calm emotions](/3-Mechanics/CLI/spells/calm-emotions.md), [charm\
    \ person](/3-Mechanics/CLI/spells/charm-person.md), [command](/3-Mechanics/CLI/spells/command.md),\
