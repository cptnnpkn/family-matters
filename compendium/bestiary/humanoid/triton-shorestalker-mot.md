...
- "desc": "The triton's spellcasting ability is Wisdom (spell save DC 12). It can\
    ...
    \ each: [fog cloud](/3-Mechanics/CLI/spells/fog-cloud.md), [gust of wind](/3-Mechanics/CLI/spells/gust-of-wind.md)"
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ creature to 0 hit points, that creature is stable but [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
