...
- "desc": "The sea fury's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ requiring no material components:\n\nAt will: [witch bolt](/3-Mechanics/CLI/spells/witch-bolt.md)\n\
    \n1/day each: [bestow curse](/3-Mechanics/CLI/spells/bestow-curse.md), [fear](/3-Mechanics/CLI/spells/fear.md),\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 13\
  ...
  "name": "Claws"
- "desc": "The sea fury targets one [frightened](/3-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "The sea fury transforms into a wave of foaming seawater, along with whatever\
    ...
    \ attacks. While in this form, it can't be [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
    \ or [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained). It reverts\
...
- "desc": "The sea fury disgorges a [swarm of poisonous snakes](/3-Mechanics/CLI/bestiary/beast/swarm-of-poisonous-snakes.md),\
...
- "desc": "- Caverns, tunnels, and pools of water within 120 feet of the sea fury\
    ...
    \ contact with the rushing [wave](/3-Mechanics/CLI/items/wave.md) must succeed\
    ...
    \ has the statistics of a [specter](/3-Mechanics/CLI/bestiary/undead/specter.md)\
...
- "desc": "- Sea water within 5 miles of the lair becomes coarse and choppy, as if\
    ...
    \ within 5 feet of it.  \n- Ordinary [crabs](/3-Mechanics/CLI/bestiary/beast/crab.md)\
    \ and [octopi](/3-Mechanics/CLI/bestiary/beast/octopus.md) within 1 mile of the\
    \ lair grow in size to become [giant crabs](/3-Mechanics/CLI/bestiary/beast/giant-crab.md)\
    \ and [giant octopi](/3-Mechanics/CLI/bestiary/beast/giant-octopus.md), respectively.\
    \ These creatures serve the sea fury as spies and guards.  "
  "name": ""
"source":
- "EGW"
"image": "/3-Mechanics/CLI/bestiary/fey/token/sea-fury-egw.webp"
```
^statblock