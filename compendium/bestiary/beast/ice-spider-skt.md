...
aliases: ["Ice Spider"]
---
# [Ice Spider](3-Mechanics\CLI\bestiary\beast/ice-spider-skt.md)
...
- "desc": "Ranged Weapon Attack: +5 to hit, range 30/60 ft., one creature. Hit:\
    ...
    \ action, the [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained) target\
...
"source":
- "SKT"
"image": "/3-Mechanics/CLI/bestiary/beast/token/ice-spider-skt.webp"
```
^statblock