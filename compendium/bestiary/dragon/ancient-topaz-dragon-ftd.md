...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ each: [antilife shell](/3-Mechanics/CLI/spells/antilife-shell.md), [bane](/3-Mechanics/CLI/spells/bane.md),\
...
- "desc": "- Crystal Profusion. Natural stone within 6 miles of the lair grows\
    ...
    \ the [clairvoyance](/3-Mechanics/CLI/spells/clairvoyance.md) spell, requiring\
