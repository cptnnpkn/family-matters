...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 20\
    ...
    \ [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) by the kraken, that\
    ...
    \ the kraken takes 35 damage or more on a single turn from a creature inside it,\
...
"source":
- "LR"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/young-kraken-lr.webp"
```
^statblock