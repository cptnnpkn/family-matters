...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one Medium or smaller\
    ...
    \ creature inside the amphora, the target is [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained)\
    \ inside. As an action, the [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained)\
    \ creature can make a DC 14 Dexterity ([Acrobatics](/3-Mechanics/CLI/rules/skills.md#Acrobatics))\
