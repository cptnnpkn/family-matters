...
- "desc": "Melee Weapon Attack: +12 to hit, reach 10 ft., one target. Hit: 15\
    \ (2d8 + 6) piercing damage plus 13 (2d12) poison damage. If the target is\
    \ a Large or smaller creature, it must succeed on a DC 20 Strength saving throw\
    \ or be swallowed by the hertilod. A swallowed creature has the [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "desc": "The hertilod drains life from the creatures in its gullet to bolster itself.\
    \ Each creature in the hertilod's gullet takes 10 (3d6) necrotic damage, and\
    \ the hertilod regains a number of hit points equal to the damage."
