...
aliases: ["James Cryon"]
---
# [James Cryon](3-Mechanics\CLI\bestiary\npc/james-cryon-crcotn.md)
*Source: Critical Role: Call of the Netherdeep p. 81*  

```statblock
"name": "James Cryon (CRCotN)"
"size": "Medium"
"type": "humanoid"
"subtype": "elf, wizard"
...
"cr": "5"
"traits":
- "desc": "James casts one of the following spells, requiring no material components\
    \ and using Intelligence as the spellcasting ability (spell save DC 15):\n\nAt\
    \ will: [alter self](/3-Mechanics/CLI/spells/alter-self.md), [light](/3-Mechanics/CLI/spells/light.md),\
  ...
  "name": "Spellcasting"
"actions":
- "desc": "James makes two Arcane Shock or Dagger of the Poisoned Mind attacks."
  "name": "Multiattack"
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/james-cryon-crcotn.webp"
```
^statblock