...
aliases: ["Clystran"]
---
# [Clystran](3-Mechanics\CLI\bestiary\npc/clystran-dsotdq.md)
...
"cr": "1/2"
"traits":
- "desc": "Clystran has advantage on Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "DSotDQ"
"image": "/3-Mechanics/CLI/bestiary/npc/token/clystran-dsotdq.webp"
```
^statblock