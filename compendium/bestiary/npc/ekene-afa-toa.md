...
"cr": "5"
"traits":
- "desc": "Ekene-Afa has advantage on saving throws against being [frightened](/3-Mechanics/CLI/rules/conditions.md#frightened)."
  "name": "Brave"
...
"source":
- "ToA"
"image": "/3-Mechanics/CLI/bestiary/npc/token/ekene-afa-toa.webp"
```
^statblock