...
"cr": "1/8"
"traits":
- "desc": "Raegrin has advantage on saving throws against being [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed)\
...
"source":
- "EGW"
"image": "/3-Mechanics/CLI/bestiary/npc/token/raegrin-mau-egw.webp"
```
^statblock