...
- "desc": "Zox is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 17, +9 to hit with spell attacks). Zox can cast [disguise self](/3-Mechanics/CLI/spells/disguise-self.md)\
...
"source":
- "WDMM"
"image": "/3-Mechanics/CLI/bestiary/npc/token/zox-clammersham-wdmm.webp"
```
^statblock