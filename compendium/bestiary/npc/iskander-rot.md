...
aliases: ["Iskander"]
---
# [Iskander](3-Mechanics\CLI\bestiary\npc/iskander-rot.md)
...
- "desc": "Iskander is presented in The Rise of Tiamat as a neutral evil male human\
    \ wizard. The [mage](/3-Mechanics/CLI/bestiary/humanoid/mage.md) stat block has\
...
- "RoT"
- "ToD"
"image": "/3-Mechanics/CLI/bestiary/npc/token/iskander-rot.webp"
```
^statblock