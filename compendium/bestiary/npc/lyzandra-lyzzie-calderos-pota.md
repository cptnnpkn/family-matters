...
---
# [Lyzandra "Lyzzie" Calderos](3-Mechanics\CLI\bestiary\npc/lyzandra-lyzzie-calderos-pota.md)
...
- "desc": "Lyzandra is a 9th-level spellcaster. Her spellcasting ability is Intelligence\
    ...
    \ [immolation](/3-Mechanics/CLI/spells/immolation-xge.md)"
  "name": "Spellcasting"
"actions":
...
"source":
- "PotA"
"image": "/3-Mechanics/CLI/bestiary/npc/token/lyzandra-lyzzie-calderos-pota.webp"
```
^statblock