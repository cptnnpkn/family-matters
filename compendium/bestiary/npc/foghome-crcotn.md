...
aliases: ["Foghome"]
---
# [Foghome](3-Mechanics\CLI\bestiary\npc/foghome-crcotn.md)
...
"cr": "2"
"traits":
- "desc": "Foghome is a 5th-level spellcaster. Its spellcasting ability is Wisdom\
    \ (spell save DC 13, +5 to hit with spell attacks). Foghome has the following\
  ...
  "name": "Spellcasting"
- "desc": "As a bonus action, Foghome can expend a spell slot to cause its melee weapon\
    \ attacks to magically deal an extra 10 (3d6) radiant damage to a target on\
    \ a hit. This benefit lasts until the end of the turn. If Foghome expends a spell\
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/foghome-crcotn.webp"
```
^statblock