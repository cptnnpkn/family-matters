...
aliases: ["Marisa"]
---
# [Marisa](3-Mechanics\CLI\bestiary\npc/marisa-crcotn.md)
...
- "desc": "One humanoid that Marisa can see within 5 feet of it must succeed on a\
    ...
    \ and loses control of its body. Marisa now controls the body but doesn't deprive\
    \ the target of awareness. Marisa can't be targeted by any attack, spell, or other\
    ...
    \ body drops to 0 hit points, Marisa ends it as a bonus action, or Marisa is turned\
    \ or forced out by an effect like the [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/marisa-crcotn.webp"
```
^statblock