...
- "desc": "Fel'rekt has advantage on saving throws against being [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed),\
...
"source":
- "WDH"
"image": "/3-Mechanics/CLI/bestiary/npc/token/felrekt-lafeen-wdh.webp"
```
^statblock