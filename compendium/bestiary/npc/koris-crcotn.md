...
aliases: ["Koris"]
---
# [Koris](3-Mechanics\CLI\bestiary\npc/koris-crcotn.md)
...
- "desc": "Koris deals an extra 14 (4d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Koris that isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/koris-crcotn.webp"
```
^statblock