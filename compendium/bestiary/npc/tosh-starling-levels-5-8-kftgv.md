...
---
# [Tosh Starling (Levels 5-8)](3-Mechanics\CLI\bestiary\npc/tosh-starling-levels-5-8-kftgv.md)
...
- "desc": "Tosh Starling deals an extra 7 (2d6) damage when it hits a target with\
    ...
    \ within 5 feet of an ally of Tosh Starling that isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
"source":
- "KftGV"
"image": "/3-Mechanics/CLI/bestiary/npc/token/tosh-starling-levels-5-8-kftgv.webp"
```
^statblock