...
---
# [The Stranger](3-Mechanics\CLI\bestiary\npc/the-stranger-kftgv.md)
...
- "desc": "The Stranger is an 18th-level spellcaster. Its spellcasting ability is\
  ...
  "name": "Spellcasting"
- "desc": "The Stranger wears an invisible [ring of mind shielding](/3-Mechanics/CLI/items/ring-of-mind-shielding.md)\
    \ that thwarts magical attempts to read their thoughts. The Stranger also wears\
    \ [dimensional shackles](/3-Mechanics/CLI/items/dimensional-shackles.md) but is\
...
"source":
- "KftGV"
"image": "/3-Mechanics/CLI/bestiary/npc/token/the-stranger-kftgv.webp"
```
^statblock