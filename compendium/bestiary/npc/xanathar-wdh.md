...
"cr": "13"
"traits":
- "desc": "Xanathar wears a [ring of invisibility](/3-Mechanics/CLI/items/ring-of-invisibility.md),\
    \ a [ring of mind shielding](/3-Mechanics/CLI/items/ring-of-mind-shielding.md),\
    \ and a [ring of resistance (force)](/3-Mechanics/CLI/items/ring-of-force-resistance.md)."
...
"source":
- "WDH"
"image": "/3-Mechanics/CLI/bestiary/npc/token/xanathar-wdh.webp"
```
^statblock