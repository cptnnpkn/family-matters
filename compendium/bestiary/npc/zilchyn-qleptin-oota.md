...
---
# [Zilchyn Q'Leptin](3-Mechanics\CLI\bestiary\npc/zilchyn-qleptin-oota.md)
...
- "desc": "Zilchyn is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Zilchyn has advantage on saving throws against being [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed),\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "Zilchyn magically summons a [quasit](/3-Mechanics/CLI/bestiary/fiend/quasit.md),\
...
"source":
- "OotA"
"image": "/3-Mechanics/CLI/bestiary/npc/token/zilchyn-qleptin-oota.webp"
```
^statblock