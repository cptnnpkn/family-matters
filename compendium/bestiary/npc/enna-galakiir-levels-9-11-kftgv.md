...
---
# [Enna Galakiir (Levels 9-11)](3-Mechanics\CLI\bestiary\npc/enna-galakiir-levels-9-11-kftgv.md)
...
- "desc": "Enna Galakiir deals an extra 14 (4d6) damage when it hits a target with\
    ...
    \ within 5 feet of an ally of Enna Galakiir that isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
"source":
- "KftGV"
"image": "/3-Mechanics/CLI/bestiary/npc/token/enna-galakiir-levels-9-11-kftgv.webp"
```
^statblock