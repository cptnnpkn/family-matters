...
---
# [Maccath the Crimson](3-Mechanics\CLI\bestiary\npc/maccath-the-crimson-rot.md)
...
- "desc": "Maccath the Crimson is presented in The Rise of Tiamat as a female tiefling\
    \ sorcerer and member of the Arcane Brotherhood. The [mage](/3-Mechanics/CLI/bestiary/humanoid/mage.md)\
...
- "RoT"
- "ToD"
"image": "/3-Mechanics/CLI/bestiary/npc/token/maccath-the-crimson-rot.webp"
```
^statblock