...
- "desc": "Kaylan targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ Kaylan. The [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed) target regards\
    \ Kaylan as a trusted friend to be heeded and protected. Although the target isn't\
    \ under Kaylan's control, it takes Kaylan's requests or actions in the most favorable\
