...
- "desc": "If a creature tries to read Dyrrn's thoughts or deals psychic damage to\
    \ it, that creature must succeed on a DC 23 Intelligence saving throw or be [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "Melee Weapon Attack: +15 to hit, reach 10 ft., one target. Hit: 24\
    ...
    \ it is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) (escape DC 23),\
    \ pulled into an unoccupied space within 5 feet of Dyrrn, and must succeed on\
    \ a DC 23 Intelligence saving throw or be [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "Dyrrn targets one creature it can see within 60 feet of it. The target\
    ...
    \ a success."
  "name": "Corruption"
- "desc": "Melee Weapon Attack: +15 to hit, reach 5 ft., one [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ creature [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) by Dyrrn.\
...
- "desc": "Dyrrn magically emits psychic energy in a 60-foot cone. Each creature in\
    ...
    \ + 8) psychic damage and be [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "- Dyrrn uses its Corruption action.  \n- A 30-foot-square area of ground\
    ...
    \ on a DC 23 Strength saving throw or be [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained).\
    \ A creature can escape the tentacles with a successful DC 23 Strength ([Athletics](/3-Mechanics/CLI/rules/skills.md#Athletics))\
