...
- "desc": "Sandesyl has the following flaws:\n\nForbiddance. Sandesyl can't enter\
    ...
    \ heart while Sandesyl is [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ in its resting place, Sandesyl is [paralyzed](/3-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Sandesyl, [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated),\
...
- "desc": "Sandesyl targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ Sandesyl. The [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed) target\
...
- "desc": "Sandesyl magically calls 2d4 swarms of [bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats.md)\
    ...
    \ sun isn't up. While outdoors, Sandesyl can call 3d6 [wolves](/3-Mechanics/CLI/bestiary/beast/wolf.md)\
