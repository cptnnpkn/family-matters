...
aliases: ["Celeste"]
---
# [Celeste](3-Mechanics\CLI\bestiary\npc/celeste-crcotn.md)
...
- "desc": "One humanoid that Celeste can see within 5 feet of it must succeed on a\
    ...
    \ and loses control of its body. Celeste now controls the body but doesn't deprive\
    \ the target of awareness. Celeste can't be targeted by any attack, spell, or\
    ...
    \ body drops to 0 hit points, Celeste ends it as a bonus action, or Celeste is\
    \ turned or forced out by an effect like the [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/celeste-crcotn.webp"
```
^statblock