...
- "desc": "The mad mage is an 18th-level spellcaster. His spellcasting ability is\
    ...
    \ [disguise self](/3-Mechanics/CLI/spells/disguise-self.md) and [invisibility](/3-Mechanics/CLI/spells/invisibility.md)\
    ...
    \ slots): [detect magic](/3-Mechanics/CLI/spells/detect-magic.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor.md),\
    ...
    \n4th level (3 slots): [Mordenkainen's faithful hound](/3-Mechanics/CLI/spells/mordenkainens-faithful-hound.md),\
    \ [polymorph](/3-Mechanics/CLI/spells/polymorph.md), [stoneskin](/3-Mechanics/CLI/spells/stoneskin.md)\n\
    ...
    \n7th level (1 slots): [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion.md)\n\
...
"source":
- "CoS"
"image": "/3-Mechanics/CLI/bestiary/npc/token/the-mad-mage-of-mount-baratok-cos.webp"
```
^statblock