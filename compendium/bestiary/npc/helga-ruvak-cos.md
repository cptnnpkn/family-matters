...
- "desc": "Helga has the following flaws:\n\nForbiddance. Helga can't enter a residence\
    ...
    \ into its heart while it is [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Helga, [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated),\
...
"source":
- "CoS"
"image": "/3-Mechanics/CLI/bestiary/npc/token/helga-ruvak-cos.webp"
```
^statblock