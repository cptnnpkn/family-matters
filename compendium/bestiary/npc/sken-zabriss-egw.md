...
"cr": "1"
"traits":
- "desc": "Sken counts as one size larger when determining her carrying capacity and\
    \ the weight she can push, drag, or lift."
  "name": "Powerful Build"
- "desc": "Sken wears a [ring of obscuring](/3-Mechanics/CLI/items/ring-of-obscuring-egw.md).\
    \ With it, she can cast the [fog cloud](/3-Mechanics/CLI/spells/fog-cloud.md)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 7 (1d8\
  ...
  "name": "Longsword"
"reactions":
- "desc": "When Sken takes damage, she can use her reaction to reduce the damage taken\
    \ by 8 (1d12 + 2)."
