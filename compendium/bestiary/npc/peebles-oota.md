...
aliases: ["Peebles"]
---
# [Peebles](3-Mechanics\CLI\bestiary\npc/peebles-oota.md)
...
- "desc": "Peebles deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Peebles that isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
"source":
- "OotA"
"image": "/3-Mechanics/CLI/bestiary/npc/token/peebles-oota.webp"
```
^statblock