...
---
# [Kiril Stoyanovich](3-Mechanics\CLI\bestiary\npc/kiril-stoyanovich-cos.md)
...
- "desc": "Kiril can use its action to polymorph into a wolf-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Kiril has advantage on Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "/3-Mechanics/CLI/bestiary/npc/token/kiril-stoyanovich-cos.webp"
```
^statblock