...
- "desc": "One humanoid that Meri can see within 5 feet of it must succeed on a DC\
    ...
    \ and loses control of its body. Meri now controls the body but doesn't deprive\
    \ the target of awareness. Meri can't be targeted by any attack, spell, or other\
    ...
    \ body drops to 0 hit points, Meri ends it as a bonus action, or Meri is turned\
...
"source":
- "CRCotN"
"image": "/3-Mechanics/CLI/bestiary/npc/token/meri-crcotn.webp"
```
^statblock