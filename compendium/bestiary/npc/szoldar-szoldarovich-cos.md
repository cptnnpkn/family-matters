...
"cr": "1/2"
"traits":
- "desc": "Szoldar has advantage on Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "/3-Mechanics/CLI/bestiary/npc/token/szoldar-szoldarovich-cos.webp"
```
^statblock