...
- "desc": "The quori's spellcasting ability is Intelligence (spell save DC 16). It\
    ...
    \ person](/3-Mechanics/CLI/spells/dominate-person.md), [dream](/3-Mechanics/CLI/spells/dream.md)\n\
    \n3/day each: [detect thoughts](/3-Mechanics/CLI/spells/detect-thoughts.md),\
...
- "desc": "Melee Spell Attack: +8 to hit, reach 5 ft., one target. Hit: 9 (1d10\
    ...
    \ Wisdom saving throw or fall [prone](/3-Mechanics/CLI/rules/conditions.md#prone)\
