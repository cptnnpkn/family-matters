...
- "desc": "The quori's spellcasting ability is Charisma (spell save DC 21, +13 to\
    ...
    \ no components:\n\nAt will: [arcane eye](/3-Mechanics/CLI/spells/arcane-eye.md)\n\
    \n3/day each: [clairvoyance](/3-Mechanics/CLI/spells/clairvoyance.md), [confusion](/3-Mechanics/CLI/spells/confusion.md),\
    \ [dream](/3-Mechanics/CLI/spells/dream.md), [eyebite](/3-Mechanics/CLI/spells/eyebite.md)"
  "name": "Innate Spellcasting (Psionics)"
- "desc": "The quori can't be surprised while it isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)."
...
- "desc": "Melee Spell Attack: +13 to hit, reach 5 ft., one target. Hit: 29\
    ...
    \ be revived by any means short of a [wish](/3-Mechanics/CLI/spells/wish.md) spell\
...
- "desc": "The quori touches one humanoid, which must succeed on a DC 21 Intelligence\
    ...
    \ or [greater restoration](/3-Mechanics/CLI/spells/greater-restoration.md) spell.\n\
    \nThe cursed target suffers 1 level of [exhaustion](/3-Mechanics/CLI/rules/conditions.md#exhaustion)\
    \ every 24 hours, and finishing a long rest doesn't reduce its [exhaustion](/3-Mechanics/CLI/rules/conditions.md#exhaustion).\
    \ If the cursed target reaches [exhaustion](/3-Mechanics/CLI/rules/conditions.md#exhaustion)\
    \ level 6, it doesn't die; it instead becomes a thrall under the quori's control,\
    \ and all its [exhaustion](/3-Mechanics/CLI/rules/conditions.md#exhaustion) is\
    \ removed. Only the [wish](/3-Mechanics/CLI/spells/wish.md) spell can free the\
    \ thrall from this control."
...
- "desc": "The quori creates a swarm of spectral eyes that fills a 30-foot-radius\
    ...
    \ 45 (10d8) psychic damage, and it is [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
    \ for 1 minute. On a success, a creature takes half as much damage and isn't [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded).\
    \ A [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded) creature can repeat\
...
"source":
- "ERLW"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/kalaraq-quori-erlw.webp"
```
^statblock