...
- "desc": "On initiative count 20 (losing initiative ties), the morkoth can take one\
  ...
  "name": ""
- "desc": "- Cast a Spell. The morkoth casts [darkness](/3-Mechanics/CLI/spells/darkness.md),\
    \ [dispel magic](/3-Mechanics/CLI/spells/dispel-magic.md), or [misty step](/3-Mechanics/CLI/spells/misty-step.md),\
...
- "desc": "- Alter Water. With a thought (no action required), the morkoth can\
    ...
    \ it can be recovered with a successful DC 15 Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception))\
