...
- **Cavernous Sight.** You gain [darkvision](/3-Mechanics/CLI/rules/senses.md#darkvision) with a range of 60 feet. If you already have [darkvision](/3-Mechanics/CLI/rules/senses.md#darkvision) from another source, its range increases by 60 feet.  
