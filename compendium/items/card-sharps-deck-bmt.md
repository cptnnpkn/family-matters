...
- **Spray of Cards.** As an action, you can shuffle the deck and cast the [Spray of Cards](/3-Mechanics/CLI/spells/spray-of-cards-bmt.md) spell at 3rd level from the deck (spell save DC 15). Once the deck has cast the spell, it can't cast the spell again until the next dawn.  
