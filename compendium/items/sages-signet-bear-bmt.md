...
While wearing the Sage's Signet, you can cast the [Enlarge/Reduce](/3-Mechanics/CLI/spells/enlarge-reduce.md) and [Polymorph](/3-Mechanics/CLI/spells/polymorph.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
