...
This figurine, crafted from rare green jasper, becomes a [tyrannosaurus rex](/3-Mechanics/CLI/bestiary/beast/tyrannosaurus-rex.md) for up to 1 hour. Once it has been used, it can't be used again until 14 days have passed.
