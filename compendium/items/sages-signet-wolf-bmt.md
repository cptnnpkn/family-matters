...
While wearing the Sage's Signet, you can cast the [Freedom of Movement](/3-Mechanics/CLI/spells/freedom-of-movement.md) and [Pass without Trace](/3-Mechanics/CLI/spells/pass-without-trace.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
