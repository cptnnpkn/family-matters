...
While wearing the Sage's Signet, you can cast the [Charm Person](/3-Mechanics/CLI/spells/charm-person.md) and [Hypnotic Pattern](/3-Mechanics/CLI/spells/hypnotic-pattern.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
