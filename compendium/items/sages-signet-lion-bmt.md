...
While wearing the Sage's Signet, you can cast the [Destructive Wave](/3-Mechanics/CLI/spells/destructive-wave.md) and [Fireball](/3-Mechanics/CLI/spells/fireball.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
